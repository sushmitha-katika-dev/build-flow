...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({ExpenseNotFoundException.class, PaymentNotFoundException.class})
    ...
    @ExceptionHandler({InvalidBudgetException.class, IllegalArgumentException.class})
