package com.buildflow.finance.client;
        ...
        try {
            ...
            if (response != null && response.containsKey("status")) {
                ...
                if ("COMPLETED".equalsIgnoreCase(status) || "CANCELLED".equalsIgnoreCase(status)) {
                    throw new IllegalArgumentException("Operation rejected: Project #" + projectId + " is " + status + ". Cannot log expenses or disburse payments to closed projects.");
                }
            }
